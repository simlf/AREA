...
var DiscordController = /** @class */ (function () {
    ...
    DiscordController.prototype.discord = function () {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(commandName === 'react')) return [3 /*break*/, 2];
                        return [4 /*yield*/, interaction.reply({ content: 'You can react with Unicode emojis!', fetchReply: true })];
                    case 1:
                        message = _a.sent();
                        message.react('😄');
                        _a.label = 2;
    ...
    DiscordController.prototype.redirect = function () {
        return { msg: 'Redirect' };
    };
    __decorate([
        (0, common_1.Get)()
    ], DiscordController.prototype, "discord");
    __decorate([
        (0, common_1.Get)('redirect')
    ], DiscordController.prototype, "redirect");
